export const EN_US_MESSAGES = {
    ...
    "attachments.rename_failed": "Could not rename attachment",
    "attachments.renamed_value0": "Renamed to {value0}",
    "attachments.shown_value0": "Showing {value0} attachments",
    "attachments.slug_cleared": "Custom name removed",
    "attachments.slug_invalid": "Names may only use lowercase letters, digits, dashes and underscores",
    "attachments.slug_placeholder": "custom-name",
    "attachments.slug_taken": "This name is already in use",
    "attachments.total_value0": "{value0} attachments",
    "attachments.unreferenced": "Unreferenced",
    "attachments.updated_note_bodies_value0": "Updated {value0} note bodies",
    "common.about": "About ",
    ...
    "editor.rename_attachment": "Rename attachment",
    "editor.rename_attachment_hint": "Choose a custom name so the file can be referenced as <name> in notes. References are rewritten automatically.",
  ...
  "workspace.a_snapshot_is_saved_every_few_minutes_or_after_larger_edits": "A snapshot is saved every few minutes or after larger edits",
    ...
    "workspace.attachment_slug_hint": "Give the file a custom name to reference it as <name> in notes.",
    "workspace.attachment_slug_label": "Custom name (optional)",
    "workspace.choose_file": "Choose file",
    "workspace.selected_files_value0": "{value0} files selected",
    "workspace.upload": "Upload",
    "workspace.upload_attachment": "Upload attachment",
