...
export const ZH_CN_MESSAGES = {
    ...
    "attachments.rename_failed": "重命名附件失败",
    "attachments.renamed_value0": "已重命名为 {value0}",
    "attachments.shown_value0": "已显示 {value0} 个附件",
    "attachments.slug_cleared": "已移除自定义名称",
    "attachments.slug_invalid": "名称只能使用小写字母、数字、连字符和下划线",
    "attachments.slug_placeholder": "自定义名称",
    "attachments.slug_taken": "该名称已被占用",
    "attachments.total_value0": "共 {value0} 个附件",
    "attachments.unreferenced": "未引用",
    "attachments.updated_note_bodies_value0": "已更新 {value0} 篇笔记",
    "common.about": "约",
    ...
    "editor.rename_attachment": "重命名附件",
    "editor.rename_attachment_hint": "为附件设置自定义名称，之后可在笔记中以 <名称> 引用。引用会自动重写。",
  ...
  "workspace.a_snapshot_is_saved_every_few_minutes_or_after_larger_edits": "每隔几分钟或改动较大时，会自动留一份存档",
    ...
    "workspace.attachment_slug_hint": "为附件设置自定义名称，之后可在笔记中以 <名称> 引用。",
    "workspace.attachment_slug_label": "自定义名称（可选）",
    "workspace.choose_file": "选择文件",
    "workspace.selected_files_value0": "已选择 {value0} 个文件",
    "workspace.upload": "上传",
    "workspace.upload_attachment": "上传附件",
