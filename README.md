...
Two files under `src/client/` — `lib/markdown/mdcss-bridge.js` and `styles/mdcss.css` — are generated by [mdcss](https://github.com/suif4599/mdcss) and should not be edited by hand; regenerate them from the mdcss repository instead.
