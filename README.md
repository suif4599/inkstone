...
Three files under `src/client/` — `lib/markdown/mdcss-bridge.js`, `lib/markdown/mdcss-runtime.js` (plus its `mdcss-runtime.d.ts`), and `styles/mdcss.css` — are generated by [mdcss](https://github.com/suif4599/mdcss) and should not be edited by hand; regenerate them from the mdcss repository instead.
